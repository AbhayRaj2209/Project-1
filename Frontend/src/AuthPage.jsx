...
function AuthPage() {
    ...
    const handleSocialLogin = (provider) => {
        // Redirects directly to the backend OAuth endpoints
            ...
            <div className="form-panel">
                <div className="form-container">
                    ...
                    <div className="social-login-group">
                        <button onClick={() => handleSocialLogin('google')} className="social-btn google" type="button">
                        ...
                        <button onClick={() => handleSocialLogin('github')} className="social-btn github" type="button">
